  ...
  return (
    <Section id="how-to-use">
        <div className='container'>
            <Heading title="Generative AI made for creators." text="Brainwave unlocks the potential of 
            ...
            <div className='relative'>
                ...
                p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]'>
                    ...
                    xl:w-auto '>
                        ...
                        height={730} width={800} src={service1} alt={service1} />
                    </div>
                ...
                <div className='relative z-1 grid gap-5 lg:grid-cols-2'>
                    ...
                    <div className='p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem]'>
                        <div className='py-12 px-4 xl:px-8'>
                            ...
                            <p className='body-2 mb-[2rem] text-n-3'> The worlds most powerful AI photo and video art generation engine. What will you create?</p>
                            <ul className='flex items-center justify-between'>
                                {brainwaveServicesIcons.map((item,index)=>(
                                    <li key={index} className={`rounded-2xl flex items-center justify-center ${index === 2 ? 
                                        'w-[3rem] h-[3rem] p-0.25 bg-conic-gradient  md:w-[4.5rem] md:h-[4.5rem]':'flex w-10 h-10 bg-n-6 md:w-15 md:h-15'}`}>
