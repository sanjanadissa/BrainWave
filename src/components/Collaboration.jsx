    ...
    <Section crosses>
        <div className='container lg:flex'>
            ...
            <div className='lg:ml-auto xl:w-[38rem]'>
                <p className='body-2 mb-8 text-n-4 md:mb-16 lg:mb-32 mt-4 lg:w-[22rem]
                 lg:mx-auto'>{collabText}</p>

                 <div className='mt-4 relative left-1/2 flex w-[22rem] aspect-square border
                        ...
                        {collabApps.map((app,index)=>(
                            ...
                            rotate-${index*45}`}>
                                ...
                                border border-n-1/15 rounded-xl -rotate-${index*45}`}>
                                    <img className='m-auto' width={app.width} height={app.height} src={app.icon} alt={app.id} />
                                </div>
